...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/rdf-normalize/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rdf-normalize.git`
* Install bundle:
  `bundle install`
...
[pr]:      https://github.com/ruby-rdf/rdf-normalize/compare/
